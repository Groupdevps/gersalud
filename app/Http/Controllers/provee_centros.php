...
class provee_centros extends Controller
{
    /**
    ...
    {
        return view('adminlte::layouts.Adminil.centros.provee_centros');
    }
    ...
    public function store(Request $request)
    {
        ...
        $newpersonal->nitcentro=$request->nit;
        ...
        $newpersonal->tarjeta_p=$request->datos[3]['value'];
        $newpersonal->save();
